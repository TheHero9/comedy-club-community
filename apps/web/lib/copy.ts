...
const en = {
  ...
  search: {
    ...
    recent: "RECENT",
    recentEpisodes: "RECENTLY OPENED",
  ...
  episode: {
    ...
    momentAdd: "Add a moment",
    momentTimeLabel: "At",
    momentTimePlaceholder: "1:30:29",
    momentWhatLabel: "What happens",
    ...
    castPick: "Choose a person",
    castCustom: "Not listed? Type a name",
  ...
  manage: {
    title: "People",
    intro:
      "Personas are the canonical list. Members can only suggest a name; you decide which person it is.",
    addTitle: "Add a person",
    nameLabel: "Name",
    namePlaceholder: "Their name",
    bioLabel: "About",
    bioPlaceholder: "A line about them (optional)",
    avatarLabel: "Photo URL",
    ...
    duplicate: "Someone with that name already exists",
    peopleEmpty: "No people yet. Add the regular cast first - members can only pick from this list.",
    ...
    queuePickPerson: "Pick the person first",
    approved: "Approved",
    rejected: "Rejected",
    rolesTitle: "Roles",
    rolesIntro:
      "Moderators can curate people and review suggestions. Only an admin can grant roles.",
    rolesSearch: "Search by name or handle",
    roleMember: "Member",
  ...
  report: {
    ...
    intro: "Tell us what is wrong. A moderator reads every report and replies here.",
    categoryLabel: "What is wrong?",
    catWrongParticipants: "Wrong people listed",
    catWrongInfo: "Wrong information",
    catNotAnEpisode: "This is not an episode",
    catBug: "Something is broken",
    catSuggestion: "A suggestion",
    catOther: "Something else",
    detailLabel: "Details",
    detailPlaceholder: "What did you see?",
    submit: "Send",
    cancel: "Cancel",
    sent: "Sent - thank you",
    duplicate: "You have already reported this",
    signedOut: "Sign in to report a problem",
    mineTitle: "Your reports",
    mineEmpty: "You have not reported anything yet.",
    statusPending: "Being looked at",
...
const bg: Copy = {
  ...
  search: {
    ...
    recent: "СКОРОШНИ",
    recentEpisodes: "ПОСЛЕДНО ОТВАРЯНИ",
  ...
  episode: {
    ...
    /* --- Moments: adding (spec 14) --- */
    momentAdd: "Добави момент",
    momentTimeLabel: "В",
    momentTimePlaceholder: "1:30:29",
    momentWhatLabel: "Какво се случва",
    ...
    castPick: "Избери човек",
    castCustom: "Няма го? Напиши име",
  ...
  manage: {
    title: "Хора",
    intro:
      "Персоните са каноничният списък. Хората могат само да предложат име; ти решаваш кой е човекът.",
    addTitle: "Добави човек",
    nameLabel: "Име",
    namePlaceholder: "Името му",
    bioLabel: "За него",
    bioPlaceholder: "Един ред за него (по избор)",
    avatarLabel: "URL на снимка",
    avatarPlaceholder: "https://... (по избор)",
    add: "Добави",
    save: "Запази",
    cancel: "Откажи",
    edit: "Редактирай",
    remove: "Премахни",
    added: "Човекът е добавен",
    saved: "Запазено",
    removed: "Човекът е премахнат",
    duplicate: "Вече има човек с това име",
    peopleEmpty:
      "Още няма хора. Добави основния състав първо - другите могат да избират само от този списък.",
    ...
    queuePickPerson: "Първо избери човек",
    approved: "Одобрено",
    rejected: "Отказано",
    rolesTitle: "Роли",
    rolesIntro:
      "Модераторите могат да управляват хората и да преглеждат предложения. Само админ раздава роли.",
    rolesSearch: "Търси по име или handle",
    roleMember: "Потребител",
    roleModerator: "Модератор",
    roleAdmin: "Админ",
    roleYou: "ти",
    roleChanged: "Ролята е обновена",
    roleSelfBlocked:
  ...
  report: {
    trigger: "Съобщи за проблем",
    title: "Съобщи за проблем",
    intro: "Кажи ни какво не е наред. Модератор чете всеки сигнал и отговаря тук.",
    categoryLabel: "Какъв е проблемът?",
    catWrongParticipants: "Грешни хора в списъка",
    catWrongInfo: "Грешна информация",
    catNotAnEpisode: "Това не е епизод",
    catBug: "Нещо не работи",
    catSuggestion: "Предложение",
    catOther: "Друго",
    detailLabel: "Подробности",
    detailPlaceholder: "Какво видя?",
    submit: "Изпрати",
    cancel: "Откажи",
    sent: "Изпратено - благодарим",
    duplicate: "Вече си съобщил за това",
    signedOut: "Влез, за да съобщиш за проблем",
    mineTitle: "Твоите сигнали",
    mineEmpty: "Още не си съобщавал за нищо.",
    statusPending: "Разглежда се",
