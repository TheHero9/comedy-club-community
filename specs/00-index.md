...
| [`08-demo-data`](08-demo-data/01-seeding-and-verification.md) | Reversible demo seeding (`seed_demo`) and the full-app verification pass on top of it. **The seed data caught a false "metadata complete" claim in our own docs: 1,076 rows were still degraded and 9 episodes were being served as public when they are members-only.** | ✅ Seeded and verified 2026-08-10 - 753 tests green |
